...
- **[infrastructure.md](./infrastructure.md)** — Database roles (readonly, readandwrite), copying production data with `scripts/copy_db.sh`, connecting locally to remote databases
